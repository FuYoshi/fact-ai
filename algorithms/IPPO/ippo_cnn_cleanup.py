"""
IPPO Training for Cleanup with Proper Fairness Metrics
...
def make_train(config: Dict, pbar: Optional[tqdm] = None):
    ...
    def train(rng: jnp.ndarray) -> Dict:
        ...
        def _update_step(runner_state, unused):
            ...
            # Scale clean_action_info by episode length
...
def get_params_save_path(
    ...
    filename = config.get("SAVE_PARAMS_AS", "ippo_cnn_cleanup")
    seed = config["SEED"]
...
def evaluate(params, env, config: Dict, save_dir: str = "evaluation/cleanup"):
...
def single_run(config):
    ...
    # TODO: Check heterogeneous agent strategy setup.
    agent_suffix = ""
